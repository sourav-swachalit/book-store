...
import { User, Package, LogOut, LogIn, Edit2, MapPin, Mail, Phone } from 'lucide-react';
            ...
            {activeTab === 'orders' && (
              <div className="space-y-4">
                {[
                  ...
                  { id: '#ORD-002', date: 'Jan 10, 2024', total: '$32.50', status: 'Shipped' },
                  { id: '#ORD-003', date: 'Jan 5, 2024', total: '$58.25', status: 'Delivered' },
                ].map((order) => (
